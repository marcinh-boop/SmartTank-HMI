/*
 * Widżet well_widget.c: wielokrotny komponent LVGL używany przez ekrany do spójnej prezentacji danych.
...
well_widget_t well_widget_create(lv_obj_t *parent)
{
    ...
    widget_label_create(parent, "STUDNIA", WELL_BLUE, LV_ALIGN_TOP_LEFT, 0, 0);
    ...
    lv_obj_set_style_bg_color(widget.vertical_bar, WELL_DARK_BLUE, LV_PART_MAIN);
    lv_obj_set_style_bg_color(widget.vertical_bar, WELL_BLUE, LV_PART_INDICATOR);
    ...
    lv_obj_set_style_text_color(widget.reserve_value, WELL_BLUE, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(widget.consumption_value, WELL_BLUE, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(widget.regeneration_value, WELL_GREEN, LV_PART_MAIN);
    ...
    float well_depth_m)
{
    ...
    lv_obj_set_style_arc_color(widget->arc, status_color, LV_PART_INDICATOR);
    lv_obj_set_style_bg_color(widget->vertical_bar, status_color, LV_PART_INDICATOR);
    lv_label_set_text(widget->status_label, status_text);
    lv_obj_set_style_text_color(widget->status_label, status_color, LV_PART_MAIN);
}
